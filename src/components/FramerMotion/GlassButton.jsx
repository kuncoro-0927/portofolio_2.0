  ...
  return (
    <Motion.a
      ...
      /* Wrapper Border: 
        ...
        */
      className={`relative cursor-pointer group p-[1px] rounded-xl overflow-hidden inline-block ${className}`}
      style={{
        background:
    ...
    >
      ...
      >
        ...
        <div className="relative h-6 flex items-center justify-center">
          ...
          {/* DEPAN */}
          <Motion.span
            className="text-white font-medium text-lg whitespace-nowrap flex items-center gap-2" // Ganti block jadi flex & tambah gap
            variants={{
          ...
          {/* BELAKANG */}
          <Motion.span
            className="absolute text-white font-medium text-lg whitespace-nowrap flex items-center gap-2" // Ganti block jadi flex & tambah gap
            variants={{
