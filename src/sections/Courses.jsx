      ...
      <div className="mx-8 sm:mx-28 md:mx-24 lg:mx-28">
        ...
        <div className="mt-5 flex flex-wrap justify-between space-y-14">
          <div className="developer flex items-start gap-7 md:gap-10">
            ...
            <div>
              ...
              <p className="text-gray-300 mt-1 md:mt-2 text-sm 2xl:text-lg">
                BNSP
              </p>
              <p className="mt-1 md:mt-3 font-extralight text-xs md:text-sm 2xl:text-lg text-[#a6a6a6]">
                62090 2513 3 0123352 2025
              </p>
              <p className="font-extralight text-xs md:text-sm 2xl:text-lg text-[#a6a6a6]">
        ...
        <div className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8 md:gap-y-14">
          ...
          <div className="developer flex items-start gap-7 md:gap-10">
            ...
            />
            <div>
              <h1 className="text-base xl:text-xl">Frontend - React</h1>
              <p className="text-gray-300 mt-1 md:mt-2 text-sm 2xl:text-lg ">
                MySkill
              </p>
              <p className="mt-1 md:mt-3 font-extralight text-xs md:text-sm 2xl:text-lg text-[#a6a6a6]">
          ...
          <div className="developer flex items-start gap-7 md:gap-10">
            ...
            />
            <div>
              <h1 className="text-base xl:text-xl">Backend - Node js</h1>
              <p className="text-gray-300 mt-1 md:mt-2 text-sm 2xl:text-lg">
                MySkill
              </p>
              <p className="mt-1 md:mt-3 font-extralight text-xs md:text-sm 2xl:text-lg text-[#a6a6a6]">
