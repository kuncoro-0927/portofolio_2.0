...
const RecentProject = () => {
  ...
  return (
    <section className="developer mx-8 sm:mx-28 md:mx-24 lg:mx-28 mt-20 xl:mt-20">
      <div className="flex items-center justify-between">
        <h2 className="text-sm sm:text-base 2xl:text-lg">
          .../Recent Project...
        </h2>
      ...
      >
        <div className="absolute top-3 right-3 md:top-6 md:right-6">
          <button className="flex text-xs md:text-sm 2xl:text-lg items-center gap-3 bg-[#f5f5f5]  text-[#121212] px-5 py-2 2xl:px-8 2xl:py-3 rounded-full shadow-lg ">
            View Project
            <BsArrowUpRight className="text-lg md:text-sm 2xl:text-lg font-bold" />
          </button>
        </div>

        {/* Tags kanan bawah */}
        <div className="absolute bottom-3 left-3 md:bottom-6 md:left-6 flex-col-reverse flex gap-2 md:flex md:flex-row md:gap-3">
          <span className="text-[#f5f5f5] bg-white/5 to-transparent backdrop-blur-sm w-fit px-5 py-2 rounded-3xl text-xs xl:text-sm 2xl:text-lg">
            {recentProject.category}
          </span>
          <span className="bg-white/5 backdrop-blur-sm w-fit px-5 py-2 rounded-3xl text-xs xl:text-sm 2xl:text-lg">
            {recentProject.year}
          </span>
        </div>
